...
def resources() -> rx.Component:
    from Web_ACMA.Web_ACMA import (
        State,
    )  # Importamos State dentro de la función para evitar importación circular

    return rx.vstack(
        # Título de la sección
        rx.heading("Recursos a tu Alcance", style={**HEADER_TITLE_STYLE}),
        # Tarjetas clickeables
        rx.flex(
            resources_type_card("Pósters", "file", State.toggle_posters),
            resources_type_card(
                "Presentaciones", "presentation", State.toggle_presentaciones
            ),
            resources_type_card(
                "Cuestionarios", "notepad-text", State.toggle_cuestionarios
            ),
        ...
        rx.cond(
            ...
            rx.box(
                ...
                rx.flex(
                    ...
                    example_resources_type_card(
                        "Cuestionario Tema 4 Historia de España.png"
                    ),
                    spacing="6",
                    justify="center",
                    flex_wrap="wrap",
