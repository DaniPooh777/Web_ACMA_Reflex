    ...
    return rx.vstack(
        ...
        rx.input(
            ...
            on_key_down=lambda e: rx.cond(
                e == "Enter", rx.event.prevent_default, rx.console_log("Tecla ignorada")
            ),
        ),
            ...
            rx.vstack(
                ...
                rx.vstack(
                    ...
                    rx.input(
                        ...
                        on_key_down=lambda e: rx.cond(
                            e == "Enter", rx.event.prevent_default, rx.console_log("")
                        ),
                        style={
                            **INPUT_STYLE,
                            "border": rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.box(
                        rx.select(
                            ...
                            style={
                                "color": rx.color_mode_cond(
                                    light=SOFT_TEXT_MAIN, dark=DARK_TEXT_MAIN
                                ),
                                "width": "100%",
                                "& .rt-SelectTrigger": {
                        ...
                        background_color=rx.color_mode_cond(
                            light=SOFT_INPUT, dark=DARK_INPUT
                        ),
                        border=rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.input(
                        ...
                        color=rx.color_mode_cond(
                            light=SOFT_TEXT_SECONDARY, dark=DARK_TEXT_SECONDARY
                        ),
                ...
                rx.button(
                    rx.cond(
                        ...
                        rx.spinner(
                            size="2"
                        ),  # Para que el usuario sepa que se está enviando el formulario
                        "Enviar Solicitud",
                    ),
                    type="submit",
